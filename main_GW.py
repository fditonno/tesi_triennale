...
def risolvi(t_fine, t_inizio, N, x_0, dx_0, onda, cristallo): #funzione per la risoluzione dell'equazione differenziale        
    ...
    sol = solve_ivp(sistema,
                    ...
                    atol=1e-8*1e-22, #errore assoluto massimo accettabile
...
print(scarto(t, B, dB, onda, cristallo))
